...
public class Ufo_Sight : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (Physics.Raycast(transform.parent.position, -dir, out hit, Mathf.Infinity,rayMask) && hit.transform.gameObject.tag == "Player" && player.GetComponent<player_Movement>().Sneaking == 0)
        {
